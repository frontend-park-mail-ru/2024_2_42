...
templates['header.hbs'] = template({'1':function(container,depth0,helpers,partials,data) {
  ...
  return '  <div class="header__auth">\r\n    '
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,'loginButton') || (depth0 != null ? lookupProperty(depth0,'loginButton') : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{'name':'loginButton','hash':{},'data':data,'loc':{'start':{'line':42,'column':4},'end':{'line':42,'column':21}}}) : helper))) != null ? stack1 : '')
    + '\r\n    '
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,'registerButton') || (depth0 != null ? lookupProperty(depth0,'registerButton') : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{'name':'registerButton','hash':{},'data':data,'loc':{'start':{'line':43,'column':4},'end':{'line':43,'column':24}}}) : helper))) != null ? stack1 : '')
    + '\r\n  </div>\r\n';
},'compiler':[8,'>= 4.3.0'],'main':function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3='function', lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
...
templates['net.hbs'] = template({'compiler':[8,'>= 4.3.0'],'main':function(container,depth0,helpers,partials,data) {
    return '<div class="net"></div>\r\n';
},'useData':true});
